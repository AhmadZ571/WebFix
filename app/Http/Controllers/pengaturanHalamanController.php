...
class pengaturanHalamanController extends Controller
{
    ...
    {
        metadata::updateOrCreate(['metakey' => '_halaman_about'], ['meta_value' => $request->_halaman_about]);
        metadata::updateOrCreate(['metakey' => '_halaman_interest'], ['meta_value' => $request->_halaman_interest]);
        metadata::updateOrCreate(['metakey' => '_halaman_award'], ['meta_value' => $request->_halaman_award]);
